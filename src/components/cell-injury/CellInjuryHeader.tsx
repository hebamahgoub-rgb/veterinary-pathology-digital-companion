...
interface CellInjuryHeaderProps {
  title: string;
  subtitle: string;
  category?: string;
  lessonId: string;
...
export const CellInjuryHeader: React.FC<CellInjuryHeaderProps> = ({
  title,
  subtitle,
  ...
  return (
    <header className="space-y-3 relative z-40 overflow-visible">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          onClick={() => onNavigate({ type: 'general_pathology' })}
          className="inline-flex items-center gap-1 text-xs font-semibold text-teal-800 hover:text-teal-950 transition-colors whitespace-nowrap cursor-pointer"
          title="Back to General Pathology"
        >
